    ...
    <div class="conmonright container">
        ...
        <div class="contentpad">
            <el-table :data="data.list" v-loading="data.loading" :header-cell-style="{ background: $protovar.tbhabg }">
                ...
                <el-table-column label="网页名" :align="$protovar.align" width="200">
                    <template slot-scope="scope">{{
                        scope.row.name
                        }}
                    </template>
                </el-table-column>
                <el-table-column label="网页链接" :align="$protovar.align" width="200">
                    <template slot-scope="scope">{{
                        scope.row.url
                        }}
                    </template>
                </el-table-column>
                <el-table-column label="图标地址" :align="$protovar.align" width="500">
                    <template slot-scope="scope">{{
                        scope.row.icon
                        }}
                    </template>
                </el-table-column>
                <el-table-column label="网页是否显示" :align="$protovar.align" width="100">
                    <template slot-scope="scope">{{
                        scope.row.pid == 2 ? '不显示' : '显示'
                        }}
                    </template>
                </el-table-column>
        ...
        <el-dialog :visible.sync="dialog.visible" :close-on-click-modal="false" class="tmdialog"
            ...
            <el-form :model="dialog.form" :rules="dialog.rules" :label-width="$protovar.fmlabwidth" ref="form"
                ...
                <div class="tmcol">
                    ...
                    <el-form-item label="是否显示" prop="pid">
                        <el-select v-model="dialog.form.pid" placeholder="是否显示">
                            <el-option
                                    label="不显示"
                                    value="2"
                            ></el-option>+
